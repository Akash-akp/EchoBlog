  ...
  return (
    <div className='h-full w-full flex flex-col items-center dark:text-white'>
      ...
      <div className='my-5 flex gap-5'>
        <Link className='rounded-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium text-md px-4 py-2 text-center dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-800'>
          Delete Account
        </Link>
