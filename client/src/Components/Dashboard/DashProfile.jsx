...
const DashProfile = () => {
  ...
  return (
    <div className='flex flex-col items-center my-5 dark:text-white '>
        <div className='mx-auto text-5xl my-3 font-semibold '>
            Profile
        </div>
        <div>
            <img src={currentUser.profilePhoto} alt='profilePhoto' className='w-[100px] h-[100px] rounded-full border border-gray-700 dark:border-gray-300'></img>
        </div>
        <div>
            <form>
                <div className='flex gap-2 text-2xl mt-5 items-center'>
                    ...
                    <input onChange={inputChangeHandler} className='bg-gray-300 dark:bg-gray-600 px-2 py-1 font-thin rounded-lg w-[330px]' value={userName} />
                </div>
                <div className='flex gap-2 text-2xl mt-5 items-center'>
                    <div className='font-semibold w-[210px]'>
                        Email Id : 
