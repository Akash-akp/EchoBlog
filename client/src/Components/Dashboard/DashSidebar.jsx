...
const DashSidebar = () => {
  return (
    <div className='w-[300px] bg-lightBgColor dark:bg-gray-800 h-full border-r-2 border-gray-300 dark:border-gray-800 shadow-xl dark:text-white text-lg flex flex-col items-center'>
